...
import 'package:flutter_kin_cake_kun/views/cake_shop_detail_ui.dart';
...
// สร้างตัวแปรเก็บรูปที่จะไปใช้กับ CarouselSlider
...
List<CakeShop> cakeShops = [
  CakeShop(
    ...
    website: 'https://www.yellowspoonpa stry.com/',
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                      onTap: () {
                        // เปิดไปหน้า CakeShopDetailUi แบบย่อกลับได้
                        // พร้อมส่งข้อมูลร้านเค้กที่ถูกเลือกไปด้วย
                        Navigator.push(
                          context,
                          MaterialPageRoute(
